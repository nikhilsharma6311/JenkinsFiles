...
properties([parameters([string('PreviousCommitId'), string('LatestCommitId'), [$class: 'ChoiceParameter', choiceType: 'PT_SINGLE_SELECT', filterLength: 1, filterable: false, name: 'Deployment_Type', randomName: 'choice-parameter-8415602183200', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: 'return[\'Validate Only:selected\',\'Deploy Only\',\'Delete Only\',\'Delete and Deploy\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', filterLength: 1, filterable: false, name: 'TESTLEVEL', randomName: 'choice-parameter-8415621733200', referencedParameters: 'Deployment_Type', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if((Deployment_Type.equals("Validate Only")) || (Deployment_Type.equals("Deploy Only")) || (Deployment_Type.equals("Delete and Deploy"))){
return[\'NoTestRun\',\'RunLocalTests\',\'RunSpecifiedTests\']
}
else {
return[\'Test not applicable while deleting components:selected:disabled\']
}''']]], [$class: 'DynamicReferenceParameter', choiceType: 'ET_FORMATTED_HTML', name: 'SpecifiedTest', omitValueField: true, randomName: 'choice-parameter-8415639527800', referencedParameters: 'TESTLEVEL', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: '''if(TESTLEVEL.equals("RunSpecifiedTests")){
inputBox="<textarea rows=\'9\' cols=\'70\' name=\'value\'></textarea>"
return inputBox
}''']]]])])
